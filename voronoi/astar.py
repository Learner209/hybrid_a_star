"""
***************************************************************************************/
*    Title: Voronoi Generalized Diagram Implementation (Astar)
*    Author: ross 1573
*    Date: 2022
...
class Astar:
    ...
    def __init__(self, vor: namedtuple, start, end) -> None:
        self.__vor = vor
    ...
    def __add_ridge(self, point) -> None:
        print(f'the add_ridge function has been called >>>>>>>>>>>>>>>>>>>>>>>')
        ...
        # append ridges
        print(f'the neighbours of the vertice is {len(neighbors)}')
        for neighbor in neighbors:
    ...
    def generate_plot(self) -> None:
        ...
        ax.add_collection(LineCollection(segments, colors='orange', lw=1.0))
