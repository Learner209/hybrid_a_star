"""
***************************************************************************************/
*    Title: Voronoi Generalized Diagram Implementation (Basic geometry operation)
*    Author: ross 1573
*    Date: 2022
...
@njit(cache=True, fastmath=True)
def distance_between_line_point(line, point, verbose = False):
    _1 = line[1] - line[0]
    _2 = point - line[0]
    _1_l = length(_1)
    _2_l = length(_2)
    ...
    _c = np.arccos(_d / (_1_l * _2_l + 1e-6))
...
def is_intersecting(_1, _2) -> bool:
    # _1, _2: <object type:array(float64, 2d, C)>
