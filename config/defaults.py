...
_C.sx = 5
_C.sy = 5
_C.syaw = np.deg2rad(120).tolist()
_C.gx = 110
_C.gy = 110
_C.gyaw = np.deg2rad(120).tolist()
_C.yaw_reso = 5
_C.obsmap = 'map.npy'
_C.alpha = 0.5
_C.potential_field_weight = 0.95
_C.steering_penalty_weight = 0.0
_C.d_o_max = 0.1
